      ...
      <div className='bg-white rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-between items-center w-[60%] p-14 pt-6'>
                ...
                {videoAsset ? (
                  ...
                  <label className='cursor-pointer'>
                    <div className='flex flex-col items-center justify-center h-full'>
                      ...
                      <p className='bg-[#fe9b00] text-center mt-10 rounded text-white text-md font-medium p-2 w-52 outline-none'>
                        Select file
                      </p>
                    </div>
                    <input
        ...
        <div className='flex flex-col gap-3 pb-10'>
          ...
          <div className='flex gap-6 mt-10'>
            ...
            <button onClick={handlePost} type='button' className='bg-[#fe9b00] text-white border-2 text-md font-medium p-2 rounded w-28 lg:w-44 outline-none'>Post</button>
          </div>
        </div>
      </div>
    </div>
